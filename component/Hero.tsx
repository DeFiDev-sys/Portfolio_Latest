      ...
      <div className="mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="inline-block px-4 py-2 mb-2 lg:mb-6 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full">
          ...
          >
            <Button size={"lg"} onClick={scrollToSection}>
              View My Projects
            </Button>
          ...
          <motion.div
            ...
            className="mt-5 lg:my-10 flex items-center justify-center gap-4"
          >
            <a
            ...
            <a
              href={profileLinkData.linkedInProfile}
              target="_blank"
              className="p-3 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            >
          ...
          <motion.div
            ...
            className="lg:hidden w-full flex items-center justify-center mt-5"
          >
